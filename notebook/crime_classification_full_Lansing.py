#!/usr/bin/env python
# coding: utf-8
# Cross-City Crime Pattern Analysis — Lansing
...
# ── Load ─────────────────────────────────────────────────────────────────────
df = pd.read_csv(os.path.join(PROC_DIR, 'lansing_clean.csv'), low_memory=False)
...
cb.save_model(os.path.join(MODEL_DIR, f'model_lansing_catboost.cbm'))
