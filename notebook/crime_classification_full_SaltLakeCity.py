#!/usr/bin/env python
# coding: utf-8
# Cross-City Crime Pattern Analysis & Transfer Learning — Salt Lake City
...
CITY       = 'Salt Lake City'
CITY_KEY   = 'salt_lake_city'   # used in file names
GRID_SIZE  = 0.01
...
# CELL 1: Load data
# ============================================================
_clean_path = os.path.join(PROC_DIR, 'slc_clean.csv')
...
# ============================================================
# CELL 3: Temporal split (60/20/20 for short 18-month window)
# ============================================================
city_events = df.copy()
...
def make_percentile_features(grid, ref_grid=None):
    ref = ref_grid if ref_grid is not None else grid
...
# ============================================================
# CELL 9: Transfer learning — NYC → SLC
# ============================================================
try:
    ...
    slc_order = list(le.classes_)
    idx_map   = [nyc_order.index(c) for c in slc_order if c in nyc_order]
