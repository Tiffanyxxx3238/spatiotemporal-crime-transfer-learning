#!/usr/bin/env python
# coding: utf-8
# Cross-City Crime Pattern Analysis — Little Rock
...
# ── Load ─────────────────────────────────────────────────────────────────────
df = pd.read_csv(os.path.join(PROC_DIR, 'little_rock_clean.csv'), low_memory=False)
...
cb.save_model(os.path.join(MODEL_DIR, f'model_little_rock_catboost.cbm'))
