#!/usr/bin/env python
# coding: utf-8
# Cross-City Crime Pattern Analysis — Dallas
...
# ── Load ─────────────────────────────────────────────────────────────────────
df = pd.read_csv(os.path.join(PROC_DIR, 'dallas_clean.csv'), low_memory=False)
...
cb.save_model(os.path.join(MODEL_DIR, f'model_dallas_catboost.cbm'))
